...
using Khaos.Web.Authorization.Core.Mvc;
using Khaos.Web.Authorization.Tests.TestHelpers;
...
namespace Khaos.Web.Authorization.Tests.Core;
...
public class RolesAuthorizationFilterTests
{
    ...
    private sealed class TrackingCondition : Khaos.Web.Authorization.Core.IContextAuthorizationCondition
    {
