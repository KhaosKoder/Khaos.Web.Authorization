...
.DESCRIPTION
    Builds and packs the Khaos.Web.Authorization solution into NuGet packages.
...
Write-Host ""
Write-Host "Packing Khaos.Web.Authorization to $OutputDirectory" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    dotnet @packArgs Khaos.Web.Authorization.sln
